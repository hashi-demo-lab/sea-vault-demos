...
kubectl apply --filename ./kubernetes_config/hashibank.yaml
kubectl expose deployment hashibank
...
kubectl apply --filename ./kubernetes_config/demo_hashibank_com_cert.yaml
